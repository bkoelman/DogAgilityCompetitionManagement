...
public static class EventArgsWithNameForNumberEntryFilterExtensions
{
    ...
    public static void ShouldBeNotifyDigitReceived(this EventArgsWithName<NumberEntryFilter> eventArgsWithName, bool isCurrentCompetitor, int competitorNumber)
    {
        Guard.NotNull(eventArgsWithName, nameof(eventArgsWithName));
    ...
    public static void ShouldBeNotifyUnknownAction(this EventArgsWithName<NumberEntryFilter> eventArgsWithName, WirelessNetworkAddress source, RemoteKey? key,
        TimeSpan? time)
    {
        Guard.NotNull(eventArgsWithName, nameof(eventArgsWithName));
        Guard.NotNull(source, nameof(source));
