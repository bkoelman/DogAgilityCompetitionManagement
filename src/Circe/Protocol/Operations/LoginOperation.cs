...
namespace DogAgilityCompetition.Circe.Protocol.Operations
{
    ...
    /// responds by sending a Keep Alive (51) operation. This enables a controller to detect at which physical port a mediator
    /// is connected and rescan ports when the connection has been interrupted.
    /// </remarks>
    [Serializable]
