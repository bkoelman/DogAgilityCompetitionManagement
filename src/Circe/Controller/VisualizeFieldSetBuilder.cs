...
public sealed class VisualizeFieldSetBuilder
{
    ...
    {
        return new VisualizeFieldSet(currentCompetitorNumber, nextCompetitorNumber, startPrimaryTimer, primaryTimerValue, secondaryTimerValue,
            currentFaultCount, currentRefusalCount, currentIsEliminated, previousPlacement);
    }
