...
public sealed class NetworkHealthReport : IEquatable<NetworkHealthReport>
{
    ...
    private NetworkHealthReport(bool isConnected, bool hasProtocolVersionMismatch, int mediatorStatus, IEnumerable<WirelessNetworkAddress> misalignedSensors,
        IEnumerable<WirelessNetworkAddress> unsyncedSensors, IEnumerable<WirelessNetworkAddress> versionMismatchingSensors, NetworkComposition? runComposition,
    ...
    {
        return new NetworkHealthReport(isConnected, HasProtocolVersionMismatch, MediatorStatus, MisalignedSensors, UnsyncedSensors, VersionMismatchingSensors,
            RunComposition, ClassCompliance);
    }
