...
public static class SystemSound
{
    ...
    {
        const NativeMethods.SoundFlags flags = NativeMethods.SoundFlags.SndAlias | NativeMethods.SoundFlags.SndAsync | NativeMethods.SoundFlags.SndNodefault;
    ...
    {
        const NativeMethods.SoundFlags flags = NativeMethods.SoundFlags.SndFilename | NativeMethods.SoundFlags.SndAsync | NativeMethods.SoundFlags.SndNodefault;
