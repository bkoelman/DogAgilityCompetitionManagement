...
namespace DogAgilityCompetition.Controller.UI.Controls
{
    ...
    public sealed class StateVisualizer : Control
    {
        ...
        private sealed class StateTransitionArrows
        {
            ...
            [NotNull]
            private Dictionary<Tuple<CompetitionClassState, CompetitionClassState>, ArrowShape>
                CreateTransitionArrowTable()
            {
                var transitions = new List<Tuple<Tuple<CompetitionClassState, CompetitionClassState>, ArrowShape>>
                {
                    ComposeTransition(CompetitionClassState.Offline, CompetitionClassState.SetupCompleted,
                        HorizontalAlignment.Center, VerticalAlignment.Bottom, VerticalAlignment.Top),
                    // ***
                    ComposeTransition(CompetitionClassState.SetupCompleted, CompetitionClassState.Offline,
                        HorizontalAlignment.Right, VerticalAlignment.Middle, VerticalAlignment.Middle),
                    ComposeTransition(CompetitionClassState.SetupCompleted, CompetitionClassState.WaitingForSync,
                        HorizontalAlignment.Center, VerticalAlignment.Bottom, VerticalAlignment.Top),
                    // ***
                    ComposeTransition(CompetitionClassState.WaitingForSync, CompetitionClassState.Offline,
                        HorizontalAlignment.Right, VerticalAlignment.Middle, VerticalAlignment.Middle),
                    ComposeTransition(CompetitionClassState.WaitingForSync, CompetitionClassState.ReadyToStart,
                        HorizontalAlignment.Center, VerticalAlignment.Bottom, VerticalAlignment.Top),
                    // ***
                    ComposeTransition(CompetitionClassState.ReadyToStart, CompetitionClassState.Offline,
                        HorizontalAlignment.Right, VerticalAlignment.Middle, VerticalAlignment.Middle),
                    ComposeTransition(CompetitionClassState.ReadyToStart, CompetitionClassState.SetupCompleted,
                        HorizontalAlignment.Left, VerticalAlignment.Top, VerticalAlignment.Middle, 3),
                    ComposeTransition(CompetitionClassState.ReadyToStart, CompetitionClassState.WaitingForSync,
                        HorizontalAlignment.Left, VerticalAlignment.Top, VerticalAlignment.Middle),
                    ComposeTransition(CompetitionClassState.ReadyToStart, CompetitionClassState.StartPassed,
                        HorizontalAlignment.Center, VerticalAlignment.Bottom, VerticalAlignment.Top),
                    // ***
                    ComposeTransition(CompetitionClassState.StartPassed, CompetitionClassState.Offline,
                        HorizontalAlignment.Right, VerticalAlignment.Top, VerticalAlignment.Middle),
                    ComposeTransition(CompetitionClassState.StartPassed, CompetitionClassState.SetupCompleted,
                        HorizontalAlignment.Left, VerticalAlignment.Bottom, VerticalAlignment.Middle, 3),
                    ComposeTransition(CompetitionClassState.StartPassed, CompetitionClassState.WaitingForSync,
                        HorizontalAlignment.Left, VerticalAlignment.Top, VerticalAlignment.Middle),
                    ComposeTransition(CompetitionClassState.StartPassed, CompetitionClassState.ReadyToStart,
                        HorizontalAlignment.Left, VerticalAlignment.Bottom, VerticalAlignment.Bottom, 2),
                    ComposeTransition(CompetitionClassState.StartPassed, CompetitionClassState.Intermediate1Passed,
                        HorizontalAlignment.Center, VerticalAlignment.Bottom, VerticalAlignment.Top),
                    ComposeTransition(CompetitionClassState.StartPassed, CompetitionClassState.FinishPassed,
                        HorizontalAlignment.Right, VerticalAlignment.Bottom, VerticalAlignment.Bottom, 2),
                    ComposeTransition(CompetitionClassState.StartPassed, CompetitionClassState.RunCompleted,
                        HorizontalAlignment.Right, VerticalAlignment.Bottom, VerticalAlignment.Bottom, 3),
                    // ***
                    ComposeTransition(CompetitionClassState.Intermediate1Passed, CompetitionClassState.Offline,
                        HorizontalAlignment.Right, VerticalAlignment.Top, VerticalAlignment.Middle),
                    ComposeTransition(CompetitionClassState.Intermediate1Passed, CompetitionClassState.SetupCompleted,
                        HorizontalAlignment.Left, VerticalAlignment.Bottom, VerticalAlignment.Middle, 3),
                    ComposeTransition(CompetitionClassState.Intermediate1Passed, CompetitionClassState.WaitingForSync,
                        HorizontalAlignment.Left, VerticalAlignment.Top, VerticalAlignment.Middle),
                    ComposeTransition(CompetitionClassState.Intermediate1Passed, CompetitionClassState.ReadyToStart,
                        HorizontalAlignment.Left, VerticalAlignment.Bottom, VerticalAlignment.Bottom, 2),
                    ComposeTransition(CompetitionClassState.Intermediate1Passed,
                        CompetitionClassState.Intermediate2Passed, HorizontalAlignment.Center, VerticalAlignment.Bottom,
                        VerticalAlignment.Top),
                    ComposeTransition(CompetitionClassState.Intermediate1Passed, CompetitionClassState.FinishPassed,
                        HorizontalAlignment.Right, VerticalAlignment.Bottom, VerticalAlignment.Bottom, 2),
                    ComposeTransition(CompetitionClassState.Intermediate1Passed, CompetitionClassState.RunCompleted,
                        HorizontalAlignment.Right, VerticalAlignment.Bottom, VerticalAlignment.Bottom, 3),
                    // ***
                    ComposeTransition(CompetitionClassState.Intermediate2Passed, CompetitionClassState.Offline,
                        HorizontalAlignment.Right, VerticalAlignment.Top, VerticalAlignment.Middle),
                    ComposeTransition(CompetitionClassState.Intermediate2Passed, CompetitionClassState.SetupCompleted,
                        HorizontalAlignment.Left, VerticalAlignment.Bottom, VerticalAlignment.Middle, 3),
                    ComposeTransition(CompetitionClassState.Intermediate2Passed, CompetitionClassState.WaitingForSync,
                        HorizontalAlignment.Left, VerticalAlignment.Top, VerticalAlignment.Middle),
                    ComposeTransition(CompetitionClassState.Intermediate2Passed, CompetitionClassState.ReadyToStart,
                        HorizontalAlignment.Left, VerticalAlignment.Bottom, VerticalAlignment.Bottom, 2),
                    ComposeTransition(CompetitionClassState.Intermediate2Passed,
                        CompetitionClassState.Intermediate3Passed, HorizontalAlignment.Center, VerticalAlignment.Bottom,
                        VerticalAlignment.Top),
                    ComposeTransition(CompetitionClassState.Intermediate2Passed, CompetitionClassState.FinishPassed,
                        HorizontalAlignment.Right, VerticalAlignment.Bottom, VerticalAlignment.Bottom, 2),
                    ComposeTransition(CompetitionClassState.Intermediate2Passed, CompetitionClassState.RunCompleted,
                        HorizontalAlignment.Right, VerticalAlignment.Bottom, VerticalAlignment.Bottom, 3),
                    // ***
                    ComposeTransition(CompetitionClassState.Intermediate3Passed, CompetitionClassState.Offline,
                        HorizontalAlignment.Right, VerticalAlignment.Top, VerticalAlignment.Middle),
                    ComposeTransition(CompetitionClassState.Intermediate3Passed, CompetitionClassState.SetupCompleted,
                        HorizontalAlignment.Left, VerticalAlignment.Bottom, VerticalAlignment.Middle, 3),
                    ComposeTransition(CompetitionClassState.Intermediate3Passed, CompetitionClassState.WaitingForSync,
                        HorizontalAlignment.Left, VerticalAlignment.Top, VerticalAlignment.Middle),
                    ComposeTransition(CompetitionClassState.Intermediate3Passed, CompetitionClassState.ReadyToStart,
                        HorizontalAlignment.Left, VerticalAlignment.Bottom, VerticalAlignment.Bottom, 2),
                    ComposeTransition(CompetitionClassState.Intermediate3Passed, CompetitionClassState.FinishPassed,
                        HorizontalAlignment.Center, VerticalAlignment.Bottom, VerticalAlignment.Top),
                    ComposeTransition(CompetitionClassState.Intermediate3Passed, CompetitionClassState.RunCompleted,
                        HorizontalAlignment.Right, VerticalAlignment.Bottom, VerticalAlignment.Bottom, 3),
                    // ***
                    ComposeTransition(CompetitionClassState.FinishPassed, CompetitionClassState.Offline,
                        HorizontalAlignment.Right, VerticalAlignment.Top, VerticalAlignment.Middle),
                    ComposeTransition(CompetitionClassState.FinishPassed, CompetitionClassState.SetupCompleted,
                        HorizontalAlignment.Left, VerticalAlignment.Bottom, VerticalAlignment.Middle, 3),
                    ComposeTransition(CompetitionClassState.FinishPassed, CompetitionClassState.WaitingForSync,
                        HorizontalAlignment.Left, VerticalAlignment.Top, VerticalAlignment.Middle),
                    ComposeTransition(CompetitionClassState.FinishPassed, CompetitionClassState.ReadyToStart,
                        HorizontalAlignment.Left, VerticalAlignment.Bottom, VerticalAlignment.Bottom, 2),
                    ComposeTransition(CompetitionClassState.FinishPassed, CompetitionClassState.RunCompleted,
                        HorizontalAlignment.Center, VerticalAlignment.Bottom, VerticalAlignment.Top),
                    // ***
                    ComposeTransition(CompetitionClassState.RunCompleted, CompetitionClassState.Offline,
                        HorizontalAlignment.Right, VerticalAlignment.Top, VerticalAlignment.Middle),
                    ComposeTransition(CompetitionClassState.RunCompleted, CompetitionClassState.SetupCompleted,
                        HorizontalAlignment.Left, VerticalAlignment.Top, VerticalAlignment.Middle, 3),
                    ComposeTransition(CompetitionClassState.RunCompleted, CompetitionClassState.WaitingForSync,
                        HorizontalAlignment.Left, VerticalAlignment.Top, VerticalAlignment.Middle)
                };
            ...
            private static PointF GetPointFor([NotNull] TextBlock block, HorizontalAlignment side,
                VerticalAlignment connection)
            {
                switch (side)
                {
        ...
        private sealed class StateBlocks
        {
            ...
            private Dictionary<CompetitionClassState, TextBlock> CreateTextBlockTable()
            {
                ...
                int offsetX = 0;
                CompetitionClassState[] states =
                    Enum.GetValues(typeof (CompetitionClassState)).Cast<CompetitionClassState>().ToArray();
                foreach (CompetitionClassState state in states)
                {
                    ...
                    var textBlock = new TextBlock(StateNames[state], owner.Font,
                        new RectangleF(textBlockTopLeft, textBlockSize));
            ...
            [NotNull]
            private static readonly Dictionary<CompetitionClassState, string> StateNames =
                new Dictionary<CompetitionClassState, string>
                {
                ...
                if (intermediateTimerCount != value)
                {
                    ...
                    if (previousState == null || !CanTransitionFromTo(previousState.Value, activeState))
                    {
                        ...
                        if (activeState != CompetitionClassState.Offline)
                        {
                            ...
                            Log.Warn(
                                $"State was reset to {activeState} because active state {activeStateBefore} has become disabled.");
                        }
                    }
        ...
        [NotNull]
        private static readonly List<ShapeState> StateRenderOrder = new List<ShapeState>
        {
            ShapeState.Disabled,
            ShapeState.None,
        ...
        [NotNull]
        private static IEnumerable<CompetitionClassState> AllStatesExcept(
            [NotNull] params CompetitionClassState[] states)
        {
