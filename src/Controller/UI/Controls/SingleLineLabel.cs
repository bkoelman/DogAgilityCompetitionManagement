...
public sealed class SingleLineLabel : Label
{
    ...
    private sealed class Reflected
    {
        ...
        static Reflected()
        {
            ...
            PropertyInfo controlDisabledColorProperty = Require(typeof(Control).GetProperty("DisabledColor", BindingFlags.NonPublic | BindingFlags.Instance));
            ...
            CreateTextFormatFlagsMethod = Require(typeof(Label).GetMethod("CreateTextFormatFlags", BindingFlags.NonPublic | BindingFlags.Instance, null,
                Array.Empty<Type>(), null));

            TextRendererDisabledTextColorMethod = Require(typeof(TextRenderer).GetMethod("DisabledTextColor", BindingFlags.NonPublic | BindingFlags.Static));
